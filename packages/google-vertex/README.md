...
For a complete working example, see: [Vertex AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/basic.ts)
...
- [Vertex AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/basic.ts)
- [Vertex AI Streaming Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/streaming.ts)
...
- [Vertex AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/basic.ts) - Chat with and without metadata
- [Vertex AI Streaming Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/streaming.ts) - Streaming with performance tracking
...
- [Vertex AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/basic.ts) - Includes embedding usage
...
- [Vertex AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/basic.ts) - Shows metadata usage with chat
- [Vertex AI Streaming Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/streaming.ts) - Metadata with streaming
...
- [Vertex AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/basic.ts) - Chat and embeddings with various models
- [Vertex AI Streaming Example](https://github.com/revenium/revenium-middleware-google-node/blob/main/packages/google-vertex/examples/streaming.ts) - Streaming with different configurations
