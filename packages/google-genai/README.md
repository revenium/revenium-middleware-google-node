...
For a complete working example, see: [Google AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/basic.ts)
...
- [Google AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/basic.ts)
- [Google AI Streaming Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/streaming.ts)
- [Google AI Embedding Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/embedding.ts)
...
- [Google AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/basic.ts) - Chat, streaming, and embeddings
- [Google AI Streaming Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/streaming.ts) - Advanced streaming patterns
- [Google AI Embedding Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/embedding.ts) - Text embeddings
...
- [Google AI Basic Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/basic.ts) - Chat and embeddings with various models
- [Google AI Streaming Example](https://github.com/revenium/revenium-middleware-google-node/blob/HEAD/packages/google-genai/examples/streaming.ts) - Streaming with different configurations
