 ...
 * Handles various base URL formats and constructs proper Revenium API endpoints.
 */
 ...
 *
 * @example
 * buildReveniumUrl('https://api.revenium.ai', '/ai/completions')
 * // Returns: 'https://api.revenium.ai/meter/v2/ai/completions'
 *
 * buildReveniumUrl('https://api.revenium.ai/meter', '/ai/completions')
 * // Returns: 'https://api.revenium.ai/meter/v2/ai/completions'
 *
 * buildReveniumUrl('https://api.revenium.ai/meter/v2', '/ai/completions')
 * // Returns: 'https://api.revenium.ai/meter/v2/ai/completions'
 */
